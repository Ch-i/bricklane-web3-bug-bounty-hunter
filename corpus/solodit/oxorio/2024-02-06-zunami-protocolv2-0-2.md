...
affected_contracts: []
derives_from: []
id: solodit-oxorio-2024-02-06-zunami-protocolv2-0-2
...
title: '[FIXED] Elevated price in USD in the `getLiquidityTokenPrice` function leads
  to money theft from the pool in `ZunamiStratBase`'
vuln_class: []
---
