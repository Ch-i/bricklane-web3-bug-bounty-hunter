...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-04-30-cyfrin-securitize-solana-bridge-v2-1-1-2
...
title: Outbound `bridge_ds_tokens` shares a single writable Wormhole sequence per
  mint, enabling contention-based denial of service and low-volume griefing against
  stale client builds
vuln_class: []
---
