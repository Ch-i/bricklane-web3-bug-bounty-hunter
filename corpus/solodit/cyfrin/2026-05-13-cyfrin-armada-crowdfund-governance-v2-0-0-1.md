...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-05-13-cyfrin-armada-crowdfund-governance-v2-0-0-1
...
title: '`ArmadaRedemption::circulatingSupply` excludes entitled-but-unclaimed ARM
  in `RevenueLock` and `ArmadaCrowdfund`'
vuln_class: []
---
