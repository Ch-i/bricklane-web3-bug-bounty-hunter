...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-12-15-cyfrin-deriverse-dex-v2-0-1-24
...
title: Missing Array Synchronization in `dividends_claim` Prevents Users from Claiming
  Dividends for Newly Added Base Currencies
vuln_class: []
---
