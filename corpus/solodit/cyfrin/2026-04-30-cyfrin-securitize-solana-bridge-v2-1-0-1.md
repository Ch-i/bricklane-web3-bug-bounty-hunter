...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-04-30-cyfrin-securitize-solana-bridge-v2-1-0-1
...
title: bridge `validate_locked_tokens` diverges from `PolicyEngine` lock semantics
  and ignores manual locks with `release_time == 0`
vuln_class: []
---
