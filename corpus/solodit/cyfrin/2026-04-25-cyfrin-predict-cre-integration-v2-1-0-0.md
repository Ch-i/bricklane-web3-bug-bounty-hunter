...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-04-25-cyfrin-predict-cre-integration-v2-1-0-0
...
title: '`prices[feedId][timestamp]` key omits `interval` — admin-supplied `startPrice`
  silently dropped on cross-interval slot collision'
vuln_class: []
---
