...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-07-13-cyfrin-zaros-0-3
...
title: Impossible to liquidate accounts with multiple active markets as `LiquidationBranch::liquidateAccounts`
  reverts due to corruption of ordering in `TradingAccount::activeMarketsIds`
vuln_class: []
---
