...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-05-13-cyfrin-armada-crowdfund-governance-v2-0-1-6
...
title: '`ArmadaGovernor::setExcludedAddresses` lacks add path; follow-on `RevenueLock`
  cohorts permanently inflate quorum'
vuln_class: []
---
