...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-07-13-cyfrin-zaros-0-4
...
title: Attacker can perform a risk-free trade to mint free USDz tokens by opening
  then quickly closing positions for markets using negative `makerFee`
vuln_class: []
---
