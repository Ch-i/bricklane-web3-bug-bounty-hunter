...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2023-11-10-cyfrin-dexe-0-9
...
title: '`DistributionProposal` ''for'' voter rewards diluted by ''against'' voters
  and missing rewards permanently stuck in `DistributionProposal` contract'
vuln_class: []
---
