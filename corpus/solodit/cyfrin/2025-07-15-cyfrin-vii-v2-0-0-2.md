...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-07-15-cyfrin-vii-v2-0-0-2
...
title: More value can be extracted by liquidations than expected due to incorrect
  transfer calculations when the violator does not own the total ERC-6909 supply for
  each `tokenId` enabled as collateral
vuln_class: []
---
