...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-06-10-cyfrin-bunni-v2-1-1-9
...
title: Potential cross-contract re-entrancy between `BunniHub::deposit` and `BunniToken`
  can corrupt Hooklet state
vuln_class: []
---
