...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-07-13-cyfrin-zaros-0-1
...
title: Attacker can steal user deposited collateral tokens by updating account nft
  token to a custom attack contract address
vuln_class: []
---
