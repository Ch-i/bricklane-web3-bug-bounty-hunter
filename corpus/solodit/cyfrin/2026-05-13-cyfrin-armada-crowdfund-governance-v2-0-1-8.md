...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-05-13-cyfrin-armada-crowdfund-governance-v2-0-1-8
...
title: '`ArmadaGovernor::resolveRatification` ejects live `securityCouncil` slot,
  not the SC that issued the veto'
vuln_class: []
---
