...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-05-02-cyfrin-beanstalk-bip-39-0-1
...
title: The previous milestone stem should be scaled for use with the new gauge point
  system which uses untruncated values moving forward
vuln_class: []
---
