...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-06-10-cyfrin-bunni-v2-1-0-0
...
title: Pools configured with a malicious hook can bypass the `BunniHub` re-entrancy
  guard to drain all raw balances and vault reserves of legitimate pools
vuln_class: []
---
