...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2026-05-12-cyfrin-molecule-onchainlab-v2-0-2-1
...
title: '`OnChainLab::fallback` `CALLTYPE_DELEGATECALL` module survives NFT transfer,
  allowing arbitrary OCL storage rewrites and ETH drain by the new owner'
vuln_class: []
---
