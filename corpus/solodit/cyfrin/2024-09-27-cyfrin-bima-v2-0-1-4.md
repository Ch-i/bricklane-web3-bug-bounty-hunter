...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-09-27-cyfrin-bima-v2-0-1-4
...
title: '`IncentiveVoting::unfreeze` doesn''t remove votes if a user has voted with
  unfrozen weight prior to freezing'
vuln_class: []
---
