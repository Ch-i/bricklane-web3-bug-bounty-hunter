...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-07-13-cyfrin-zaros-1-7
...
title: Keeper fills market order using incorrect old `marketId` but newly updated
  position size when trader updates open order immediately before keeper processes
  original order
vuln_class: []
---
