...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-06-10-cyfrin-bunni-v2-1-0-1
...
title: '`FloodPlain` selector extension does not prevent `IFulfiller::sourceConsideration`
  callback from being called within pre/post hooks'
vuln_class: []
---
