...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2024-09-27-cyfrin-bima-v2-0-1-2
...
title: When `BabelVault` uses an `EmissionSchedule` but receivers have no voting weight,
  the vault's unallocated supply will decrease even though no tokens are being allocated
vuln_class: []
---
