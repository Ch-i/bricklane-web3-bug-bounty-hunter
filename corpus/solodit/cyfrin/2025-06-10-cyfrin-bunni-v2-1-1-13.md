...
affected_contracts: []
derives_from: []
id: solodit-cyfrin-2025-06-10-cyfrin-bunni-v2-1-1-13
...
title: '`BunniHook::beforeSwap` does not account for vault fees paid when adjusting
  raw token balances which could result in small losses to liquidity providers'
vuln_class: []
---
