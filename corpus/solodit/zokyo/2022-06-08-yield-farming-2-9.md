...
affected_contracts: []
derives_from: []
id: solodit-zokyo-2022-06-08-yield-farming-2-9
...
title: In contract UnifarmNftManagerUpgradeable, all the revert messages form the
  require functions are very short and hard to understand, we understand the reason
  for this was the gas optimization but this is not necessary, the strings in solidit
vuln_class: []
---
