...
affected_contracts: []
derives_from: []
id: solodit-zachobront-2023-05-26-stakedao-0-1
...
title: '[M-02] `createBounty()` doesn''t confirm that a `rewardToken` exists, which
  can be used to steal deterministic tokens'
vuln_class: []
---
