...
affected_contracts: []
derives_from: []
id: solodit-hexens-2024-11-25-basisos-0-1
...
title: '[LOGLAB-10] Unable to redeem all user shares or sell all products and close
  the hedge when the decreaseSizeMax config is different from type(uint256).max'
vuln_class: []
---
