...
affected_contracts: []
derives_from: []
id: solodit-hexens-2024-11-25-basisos-1-1
...
title: '[LOGLAB-18] $.pendingDecreaseCollateral variable will be updated incorrectly
  if the agent executes an insufficient response, leading to an imbalance in the strategy
  after unpausing'
vuln_class: []
---
