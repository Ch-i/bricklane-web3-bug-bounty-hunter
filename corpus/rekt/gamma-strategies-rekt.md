...
severity: Critical
source: rekt
source_url: https://rekt.news/gamma-strategies-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $4,500,000_  
_Incident date: 01/04/2024_  
_Pre-exploit audit: Out of scope_  

> Gamma Strategies, an Arbitrum-based concentrated liquidity management protocol, was exploited for at least $4.5M, earlier today. Recently we wondered, "Can we do better this year?". So far, it’s not looking good.


_Source: [https://rekt.news/gamma-strategies-rekt/](https://rekt.news/gamma-strategies-rekt/)_
