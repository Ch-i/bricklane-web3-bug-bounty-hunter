...
severity: Critical
source: rekt
source_url: https://rekt.news/astroport-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $6,400,000_  
_Incident date: 07/30/2024_  
_Pre-exploit audit: N/A_  

> A DEX on the Terra network, @astroport_fi, fell victim to a hack resulting in losses of roughly $6.4 million. The attack exploited a vulnerability that was known and patched in April, only to be accidentally reintroduced in a June upgrade.


_Source: [https://rekt.news/astroport-rekt/](https://rekt.news/astroport-rekt/)_
