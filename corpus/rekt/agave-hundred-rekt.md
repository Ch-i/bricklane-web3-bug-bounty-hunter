...
severity: Critical
source: rekt
source_url: https://rekt.news/agave-hundred-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $11,700,000_  
_Incident date: 03/15/2022_  
_Pre-exploit audit: Unaudited_  

> Two forks met the same fate. Agave DAO and Hundred Finance both fell victim to the same reentrancy attack. A combined total of $11.7M stolen. Considering the structure of DeFi today, the double damage is not surprising.


_Source: [https://rekt.news/agave-hundred-rekt/](https://rekt.news/agave-hundred-rekt/)_
