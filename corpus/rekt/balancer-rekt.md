...
affected_contracts: []
derives_from: []
id: rekt-balancer-rekt
ingested_at: '2026-05-15T14:50:15Z'
protocol_category: []
published_at: '2023-09-02T00:00:00Z'
related_swc: []
severity: Critical
source: rekt
source_url: https://rekt.news/balancer-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $2,100,000_  
_Incident date: 08/27/2023_  
_Pre-exploit audit: Out of scope_  

> Balancer has had a bit of a wobble. First came a warning. Then, last Sunday, the AMM (along with ‘official partner’ Beethoven X) lost $2.1M from v2 Boosted pools.


_Source: [https://rekt.news/balancer-rekt/](https://rekt.news/balancer-rekt/)_
