...
severity: Critical
source: rekt
source_url: https://rekt.news/zunami-protocol-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $2,100,000_  
_Incident date: 08/13/2023_  
_Pre-exploit audit: Hashex_  

> The Curve ecosystem can't catch a break... Yesterday, Zunami Protocol lost $2.1M to a price manipulation attack. Keeping DeFi safe is a constant game of cat-and-mouse, one that can’t always be won.


_Source: [https://rekt.news/zunami-protocol-rekt/](https://rekt.news/zunami-protocol-rekt/)_
