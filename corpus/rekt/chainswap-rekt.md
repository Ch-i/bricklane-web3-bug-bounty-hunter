...
severity: Critical
source: rekt
source_url: https://rekt.news/chainswap-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $4,400,000_  
_Incident date: 07/11/2021_  
_Pre-exploit audit: Unaudited_  

> As the demand for DeFi increases across chains, the bridges that join them turn into targets themselves. A chain is only as strong as its weakest link… Who will break next?


_Source: [https://rekt.news/chainswap-rekt/](https://rekt.news/chainswap-rekt/)_
