...
severity: Critical
source: rekt
source_url: https://rekt.news/transit-swap-rekt/
tags:
- rekt
- exploit
- post-mortem
...
_Loss: $21,200,000_  
_Incident date: 10/02/2022_  
_Pre-exploit audit: Out of scope_  

> Transit Swap has lost $21M to a vulnerability in its swap contracts. The cooperation between multiple security teams led to 70% of funds being returned. But a protocol using live, unverified contracts is never a good look in DeFi.


_Source: [https://rekt.news/transit-swap-rekt/](https://rekt.news/transit-swap-rekt/)_
