...
severity: Critical
source: rekt
source_url: https://rekt.news/voltage-finance-rekt/
tags:
- rekt
- exploit
- post-mortem
- protocol:voltage-finance
- protocol:ola-finance
- protocol:rekt
- loss-bucket:1M-plus
...
_Loss: $4,000,000_  
_Incident date: 03/31/2022_  
_Pre-exploit audit: Unaudited_  

> Voltage Finance has been exploited for ~$4M via its partner Ola Finance. Earlier this month, a similar incident on the xDAI chain gave the teams using Compound’s code plenty of warning. But somehow, neither Voltage nor Ola got the news.


_Source: [https://rekt.news/voltage-finance-rekt/](https://rekt.news/voltage-finance-rekt/)_
